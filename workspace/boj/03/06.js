...
// input[i]에 parseInt로 감싸면 안되는 이유: input[i] 자체가 문자열을 담기 떄문. 예를 들어 '3 4'라는 배열이 input[i]에 들어갈 경우 '3 4'-> '3'의 숫자만 남음.
// for (let i = 1; i < num + 1; i++) {
//   const two = input[i].split(" ");
//   const a = parseInt(two[0]);
//   const b = parseInt(two[1]);
//   console.log(a + b);
// }
